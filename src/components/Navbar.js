      	...
      	<nav class="flex justify-between h-full">
        	<div class="flex p-4">
				<a href="https://dribblee-clone.vercel.app/" class="flex items-center space-x-1 rtl:space-x-reverse pr-7">
					<img src={Dribble} class="h-11" alt="Flowbite Logo"/>
					<span class="pl-2 text-3xl font-bold text-italic dark:text-black">Dribblee</span>
				</a>
			...
			<div class="flex m-2 p-1">
				<button className="dark:bg-pink-500 px-4 py-2 text-[15px] m-1 font-bold text-white rounded-md hover:bg-pink-400">Start a free project</button>
				<button class="text-white bg-blue-700 hover:bg-blue-400 font-bold rounded-md text-[15px] px-4 py-2 m-1">Sign in / Sign Up</button>
        	</div>            
      	</nav>
  	)
}
